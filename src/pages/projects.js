  ...
  useEffect(() => {
    async function getStars() {
      const repos = await fetch(
        'https://api.github.com/users/paravsingla/repos?per_page=100'
      )
                ...
                <div className="card anchored large" key={project.slug}>
                  <div className="stars">
                    {repos.find((repo) => repo.name === project.slug) && (
                      <div className="star">
                        <a
                          href={`https://github.com/paravsingla/${project.slug}/stargazers`}
                        >
                          {Number(
                            repos.find((repo) => repo.name === project.slug)
                              .stargazers_count
                  ...
                  <div>
                    ...
                    <a
                      ...
                      href={`https://github.com/paravsingla/${project.slug}`}
                      target="_blank"
                      rel="noreferrer"
                    >
                      {project.name}
